 ...
 */
static Sock::status_t connectTo(const char* hostname,
                                unsigned int port,
                                int& sock);

static Sock::status_t connectTo(int sock,
                                const char* hostname,
                                unsigned int port);
 ...
 */
static Sock::status_t readBlocking(int fd, char* buf, int buflen, int& nread);
 ...
 */
static Sock::status_t writeBlocking(int fd, 
                                    const char *buf, 
                                    int buflen, 
                                    int& nwritten);
 ...
 */
static Sock::status_t hostToIpAddr(const char *hostname, std::string& ipAddr);
 ...
 */
static Sock::status_t getSockName(int sock, 
                                  std::string& ipaddr, 
                                  unsigned short& port);
 ...
 * @pre sock is a valid connected socket
 */
static Sock::status_t getPeerName(int sock,
                                  std::string& ipaddr, 
                                  unsigned short& port);

// wrap the socket() call
static Sock::status_t create(int domain, int type, int protocol, int& sockfd);
